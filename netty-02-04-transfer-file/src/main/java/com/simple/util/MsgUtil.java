...
import com.simple.constant.TransferTypeEnum;
import com.simple.entity.FileBurstData;
import com.simple.entity.FileBurstInstruct;
import com.simple.entity.FileDescInfo;
...
public class MsgUtil {
    ...
    public static FileTransferProtocol buildRequestTransferFile(String fileUrl, String fileName, Long fileSize) {
        ...
        fileTransferProtocol.setTransferType(TransferTypeEnum.REQUEST_TRANSFER_FILE.getIndex());
