...
public class MyServerChunkHandler extends ChannelOutboundHandlerAdapter {
    ...
    public void write(ChannelHandlerContext ctx, Object msg, ChannelPromise promise) throws Exception {
        ...
        // 如果这里是文件的传输，还可以用到 FileRegion 的一个实现，或者Netty的默认实现，来进行分区纯属
        // netty对于该类的描述：通过支持零拷贝的文件传输的 Channel 来发送的文件区域
        ChunkedStream stream = new ChunkedStream(in, 10);
        // 管道消息传输承诺，progressivePromise可以来实时获取传输的进度
