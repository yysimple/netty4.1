 ...
 **/
public class WsNettyServerChannelHandler extends ChannelInboundHandlerAdapter {
    private final Logger logger = LoggerFactory.getLogger(WsNettyServerChannelHandler.class);
    ...
    public void channelActive(ChannelHandlerContext ctx) throws Exception {
        ...
        logger.info("远程IP:{}", channel.remoteAddress().getHostString());
        logger.info("远程Port:{}", channel.remoteAddress().getPort());
