package com.simple.server.common;
 ...
 *
 * @author: WuChengXing
 * @create: 2021-12-19 11:50
 **/
@SuppressWarnings("all")
public abstract class NettyServerCommonHandler extends SimpleChannelInboundHandler<String> {
    protected boolean sentFlag;
    private Runnable counterTask;
    private final AtomicLong consumeMsgLength = new AtomicLong();
